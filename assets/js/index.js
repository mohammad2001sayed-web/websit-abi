...
function initPlanetsSection() {
  ...
  const allPlanetsData = {
    uranus: {
      name: "Uranus",
      color: "#06b6d4",
      bgBadge: "bg-cyan-500/50 text-cyan-200",
      type: "Ice Giant",
      distanceAU: "19.19",
      diameter: "50,724",
      massE: "14.536",
    ...
    neptune: {
      name: "Neptune",
      color: "#2563eb",
      bgBadge: "bg-blue-500/50 text-blue-200",
      type: "Ice Giant",
      distanceAU: "30.07",
      diameter: "49,244",
      massE: "17.148",
    ...
    jupiter: {
      name: "Jupiter",
      color: "#fb923c",
      bgBadge: "bg-purple-500/50 text-purple-200",
      type: "Gas Giant",
      distanceAU: "5.20",
      diameter: "139,820",
      massE: "317.829",
    ...
    mars: {
      name: "Mars",
      color: "#ef4444",
      bgBadge: "bg-orange-500/50 text-orange-200",
      type: "Terrestrial",
      distanceAU: "1.52",
      diameter: "6,779",
      massE: "0.107",
      ...
      moonsCount: "2",
      description:
        "Mars is the fourth planet from the Sun and the second-smallest planet in the Solar System. Often referred to as the 'Red Planet' due to the iron oxide prevalent on its surface.",
      distance: "227.9M km",
      radius: "3,389 km",
      mass: "6.39 × 10²³ kg",
      density: "3.93 g/cm³",
    ...
    mercury: {
      ...
      moonsCount: "0",
      description:
        "Mercury is the smallest planet in our Solar System and the closest to the Sun. Its orbit around the Sun takes 87.97 Earth days, the shortest of all the Sun's planets.",
      distance: "57.9M km",
      radius: "2,439 km",
      mass: "3.285 × 10²³ kg",
      density: "5.43 g/cm³",
    ...
    earth: {
      ...
      moonsCount: "1",
      description:
        "Earth is the third planet from the Sun and the only astronomical object known to harbor life. About 29% of Earth's surface is land consisting of continents and islands, while 71% is covered with water.",
      distance: "149.6M km",
      radius: "6,371 km",
      mass: "5.972 × 10²⁴ kg",
      density: "5.51 g/cm³",
    ...
    venus: {
      ...
      moonsCount: "0",
      description:
        "Venus is the second planet from the Sun. It is a terrestrial planet and is the closest in size and mass to Earth, often called Earth's twin, though it has a massive, toxic atmosphere.",
      distance: "108.2M km",
      radius: "6,051 km",
      mass: "4.867 × 10²⁴ kg",
      density: "5.24 g/cm³",
      orbitalPeriod: "225 days",
      rotation: "5,832 hours",
      moons: "0",
      gravity: "8.87 m/s²",
      discoveredBy: "Known since antiquity",
      discoveryDate: "Ancient times",
  ...
  function updatePlanetUI(planetId) {
    ...
    if (factsList) {
      factsList.innerHTML = data.quickFacts
        .map(
          (fact) => `
  ...
  planetCards.forEach((card) => {
    card.addEventListener("click", function () {
      ...
      const planetColor = this.getAttribute("style").match(
        /--planet-color:\s*(#[a-fA-A0-9]+)/,
      )[1];
